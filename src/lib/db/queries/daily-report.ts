// src/lib/db/queries/daily-report.ts

/**
 * Daily Report Analytics
 * Gets PaymentMethod data for last 24 hours for Google Chat reports
 */
 ...
 */
export async function getDailyReportAnalytics(): Promise<DailyReportAnalytics> {
  await connectDB();
  ...
  // Query PaymentMethods from last 24 hours
